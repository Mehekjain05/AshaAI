  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3 flex justify-end mt-2">
                <button
                  type="submit"
                  className="bg-purple-700 text-white px-6 py-2 rounded-md font-medium hover:bg-purple-800 transition-colors"
                >
                  Search Jobs
                </button>
              </div>
              ...
              <div key={job.id} className="bg-white rounded-lg shadow border overflow-hidden">
                <div className="p-5">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className={`text-sm font-medium ${job.jobType === 'Full-time' ? 'text-purple-600' : 'text-purple-800'}`}>
                      {job.jobType}
                    </span>
                  </div>
      ...
      <div className="fixed bottom-6 right-6">
        <button className="bg-purple-700 text-white p-4 rounded-full shadow-lg">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
