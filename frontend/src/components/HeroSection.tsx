...
const HeroSection: React.FC = () => {
  return (
    <div className="bg-purple-700 rounded-lg mt-8 mb-12 p-10 text-white">
      <div className="max-w-2xl">
        ...
        <button className="bg-white text-purple-700 px-5 py-3 rounded-md flex items-center space-x-2">
